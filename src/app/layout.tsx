...
export const metadata: Metadata = {
  title: "Rob Doe | Personal Portfolio",
  description: "Rob is a full-stack developer with 8 years of experience.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body
        className={`${inter.className} bg-gray-50 text-gray-950 relative pt-32 sm:pt-36 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90 transition-colors`}
      >
